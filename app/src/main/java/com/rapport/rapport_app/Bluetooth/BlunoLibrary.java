package com.rapport.rapport_app.Bluetooth;
...
public abstract  class BlunoLibrary extends AppCompatActivity {
	...
	String bathaddr="80:30:DC:E8:EF:F6";
	String massageaddr="80:30:DC:E9:25:0E";
	String bookaddr="80:30:DC:E9:08:AD";
		...
		public void onLeScan(final BluetoothDevice device, int rssi,
			...
			((Activity) mainContext).runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					if(device.getAddress().equals(bathaddr)||device.getAddress().equals(massageaddr)
							||device.getAddress().equals(bookaddr)) {
