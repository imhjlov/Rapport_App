package com.rapport.rapport_app.Picker;
...
/**
 * Created by Hyunjung on 2017-11-14.
 */
...
public class TimePicker extends LinearLayout {
    ...
    private void init(Context mContext) {
        ...
        myPickerView = inflator.inflate(R.layout.lay_timepicker, null);
    ...
    private void initializeReference() {
        ...
        am_pm = (TextView) myPickerView.findViewById(R.id.am_pm);
